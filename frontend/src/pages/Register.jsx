...
const Register = () => {
    ...
    const [form, setForm] = useState({ name: '', username: '', email: '', password: '', cpassword: '', avatar: '', location: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        const { password, cpassword, avatar } = form;
        ...
        myForm.append('avatar', form.avatar);
